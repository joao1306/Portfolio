      ...
      <div id='bloco-sobre-mim'>
        ...
        <div id='bloco-texto-sobre-mim'>
          ...
          <div id='bloco-infos-sobre-mim'>
            <div className='item-bloco-info'>1</div>
            <div className='item-bloco-info'>2</div>
            <div className='item-bloco-info'>3</div>
            <div className='item-bloco-info'>4</div>
          </div>
          <div id='botao-curriculo'></div>
        </div>
      </div>
